...
const msgExecuteContractMintONFTMsg = {
  message: `***New NFT Minted!*** \n[View on Omniflix Market](https://omniflix.market/nft/{ACTIVITYNFT_IDID})`,
  ownerMsg: `***You minted a new NFT!*** \n[View on Omniflix Market](https://omniflix.market/nft/{ACTIVITYNFT_IDID})`,

  url: `https://omniflix.market/nft/{ACTIVITYNFT_IDID}`
}

const executeContractMinterContractMintMsg = {
  message: `***New NFT Minted!*** \n[View on Omniflix Market](https://omniflix.market/nft/{ACTIVITYNFT_IDID})`,
  ownerMsg: `***You minted a new NFT!*** \n[View on Omniflix Market](https://omniflix.market/nft/{ACTIVITYNFT_IDID})`,
...
const executeContractUpdateMinterContractDropMsg = {
  message: `***Minter Contract Drop Updated!*** \n[View on Omniflix Market](https://omniflix.market/nft/{ACTIVITYNFT_IDID})`,
  url: `https://omniflix.market/nft/{ACTIVITYNFT_IDID}`
}

const executeContractUpdateMinterContractMsg = {
  message: `***Minter Contract Updated!*** \n[View on Omniflix Market](https://omniflix.market/nft/{ACTIVITYNFT_IDID})`,
  url: `https://omniflix.market/nft/{ACTIVITYNFT_IDID}`
}

const instantiateContractTemplate = {
  message: `***Contract Instantiated!*** \nContract Address: {CONTRACT_ADDRESS}`
}

const executeContractUpdateDenomMsg = {
  message: `***Denom Updated!*** \n[View on Omniflix Market](https://omniflix.market/collection/{DENOMID})`,
  url: `https://omniflix.market/collection/{DENOMID}`
}

const saveMinterContractTemplate = {
  message: `***Minter Contract Saved!*** \nContract Address: {CONTRACT_ADDRESS}`
}

const saveWhitelistContractTemplate = {
  message: `***Whitelist Contract Saved!*** \nContract Address: {CONTRACT_ADDRESS}`
}

const executeContractUpdateRoyaltyRatioMsg = {
  message: `***Royalty Ratio Updated!*** \nContract Address: {CONTRACT_ADDRESS}`
}

const createMinterContractDropMsg = {
  message: `***Minter Contract Drop Created!*** \nContract Address: {CONTRACT_ADDRESS}`
}

const IBCInCreateDenomMsg = {
  message: `***New Collection Created!*** \n[View on Omniflix Market](https://omniflix.market/collection/{DENOMID})`,
  url: `https://omniflix.market/collection/{DENOMID}`
}

const IBCInTransferNFTMsg = {
  sender: `***You transferred a NFT.*** \n[View on Omniflix Market](https://omniflix.market/nft/{ACTIVITYID})`,
  recipient: `***You received a NFT.*** \n[View on Omniflix Market](https://omniflix.market/nft/{ACTIVITYID})`,
  url: `https://omniflix.market/nft/{ACTIVITYID}`
}

const removeMinterContractDropMsg = {
  message: `***Minter Contract Drop Removed!*** \nContract Address: {CONTRACT_ADDRESS}`
}
...
module.exports = {
  ...
  escapeMarkdown,
  msgExecuteContractMintONFTMsg,
  executeContractMinterContractMintMsg,
  executeContractUpdateMinterContractDropMsg,
  executeContractUpdateMinterContractMsg,
  executeContractUpdateDenomMsg,
  instantiateContractTemplate,
  saveMinterContractTemplate,
  saveWhitelistContractTemplate,
  executeContractUpdateRoyaltyRatioMsg,
  createMinterContractDropMsg,
  IBCInCreateDenomMsg,
  IBCInTransferNFTMsg,
  removeMinterContractDropMsg
}
